...
const rooms = [
    ...
    },
    {
        ...
        price: "₹8700",
        tags: ["Luxury", "Beach"],
        image: "./public/Rooms/room3.png",
    },
    {
        title: "Rambagh Palace ",
        location: "Jaipur,Rajasthan",
        price: "₹6000",
        tags: ["Swimming", "Adventurous"],
        image: "./public/Rooms/room4.png",
    },
];
...
const DeluxeRooms = () => {
    ...
    return (
        <section className="py-16 px-4 bg-white text-center">
            <h2 className="text-3xl font-semibold mb-10 text-gray-800">Deluxe Rooms</h2>
