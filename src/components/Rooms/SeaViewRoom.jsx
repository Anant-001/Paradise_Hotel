...
const rooms = [
    {
        ...
        image: "./public/searoom/room1.png",
    },
    {
        title: "Sea Queen Beach",
        location: " Betalbatim, Goa",
        price: "₹7900",
        tags: ["scenery", "Budget"],
        image: "./public/searoom/room2.png",
    },
    {
        title: "Arabian",
        location: "Morjim, Goa",
        price: "₹8700",
        tags: ["Luxury", "Beach"],
        image: "./public/searoom/room3.png",
    },
    {
        title: "Sai Vishram Beach",
        location: "Baindur, Karnataka",
        price: "₹6040",
        tags: ["Resort", "Adventurous"],
        image: "./public/searoom/room4.png",
    },
];
...
const SeaViewRoom = () => {
    ...
    return (
        <section className="py-16 px-4 bg-white text-center">
            <h2 className="text-3xl font-semibold mb-10 text-gray-800">Sea View Room</h2>
